  ...
  items = [
    {
      ...
      description : 'الدكتورة آية لديها  خبرة كبيرة في متابعة التبويض ولها خبرة واسعة بوسائل منع الحمل وتنظيم الأسرة وتركيب اللولب النحاسي والهرموني و علاج الإلتهابات المهبلية الحادة والمزمنة',
